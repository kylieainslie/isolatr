...
evaluating and identifying optimal testing strategies for quarantined
individuals. The methods shown here are based on the analysis scripts in
`inst/examples/` and illustrate how to:
...
3.  Identify optimal schedules for different scenarios and quarantine
    durations
...
Now we loop over quarantine durations and TTIQ scenarios, evaluating all
...
differential quarantine by vaccination status:
...
Typical runtime: ~30-60 minutes for complete analysis (all scenarios ×
